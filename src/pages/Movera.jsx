  ...
  return (
		<>
			...
			<div className='work-container' id="work-movera">
				...
				<img src='../static/movera-cover.png' alt='Movera Cover' className='work-image'/>
				<header>
					<h2>Movera</h2>
				...
				<article>
					...
					<img src='../static/movera-image-1.png' alt='Movera Image 1' className='work-image'/>
					...
					<section>
						<img src='../static/movera-image-2.png' alt='Movera Image 2' className='work-image movera-image-2'/>
						<img src='../static/movera-image-3.png' alt='Movera Image 3' className='work-image'/>
					</section>
					...
					<section>
						...
						<img src='../static/movera-image-4.png' alt='Movera Image 4' className='work-image'/>
					</section>
